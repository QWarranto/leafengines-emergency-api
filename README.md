# LeafEngines Emergency API

**Emergency deployment for 1,532 waiting developers** - Immediate API access while we build the permanent v3.0.0 infrastructure.
...
**This is a temporary deployment** to serve 1,532 developers while we build the permanent v3.0.0 infrastructure.
...
#### Public Monitoring
```
GET /v1/monitor/public
```

### **Rate Limits:**
- **Test Key:** 100 requests/day
- **Emergency Tier:** 1,000 requests/day
- **Production Tier:** Coming in v3.0.0

### **Migration Plan:**
This emergency API will be **deprecated on May 5, 2026** when v3.0.0 launches with:
- Quality transparency envelopes
- Production infrastructure
- Enterprise-grade reliability
- Full documentation

### **Getting Production Access:**
Email `developers@leafengines.com` for:
- Higher rate limits
- Production API keys
- Early access to v3.0.0 beta
- Enterprise integration support

## 📞 Support

- **Emergency Support:** developers@leafengines.com
- **Documentation:** [LeafEngines API Docs](https://app.soilsidekickpro.com/api-docs)
- **Community:** [n8n Community](https://community.n8n.io), [Node-RED Forum](https://discourse.nodered.org)

---

**Note:** This is an emergency deployment. For production use, wait for v3.0.0 release on May 5, 2026.